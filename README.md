...
- **Finish time**: Finishing a time will stop the timer on harvest and (if any) will log the time on target process. You can choose a time to finish to bulk finish all times of a specific day (default to today).
